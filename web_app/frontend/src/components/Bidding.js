...
const CreateAuctionForm = ({ showModal, handleCloseModal, itemId, userId }) => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${config.AUCTION_SERVICE_URL}/create-auction`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          starting_time: auctionDetails.startingTime,
          ending_time: auctionDetails.endingTime,
          seller_id: userId,
          item_id: itemId,
        }),
      });
      ...
      <Modal.Body>
        <Form onSubmit={handleFormSubmit}>
          ...
          <Form.Group controlId="startingTime">
            <Form.Label>Starting Time (UTC)</Form.Label>
            <Form.Control
              type="datetime-local"
          ...
          <Form.Group controlId="endingTime">
            <Form.Label>Ending Time (UTC)</Form.Label>
            <Form.Control
              type="datetime-local"
